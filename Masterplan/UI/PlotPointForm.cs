...
namespace Masterplan.UI
{
	internal class PlotPointForm : Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.MainToolbar.Items.AddRange(settingsMenu);
			...
			this.SettingsMenu.DropDownItems.AddRange(settingsColour);
			...
			this.XPBox.Maximum = new decimal(numArray1);
			int[] numArray2 = new int[] { 100000, 0, 0, -2147483648 };
			this.XPBox.Minimum = new decimal(numArray2);
			...
			this.ParcelList.Columns.AddRange(parcelHdr);
			...
			this.ParcelToolbar.Items.AddRange(parcelAddBtn);
			...
			this.ParcelAddBtn.DropDownItems.AddRange(parcelAddParcel);
			...
			this.EncyclopediaToolbar.Items.AddRange(encyclopediaAddBtn);
			...
			this.LinkList.Columns.AddRange(linkHdr);
