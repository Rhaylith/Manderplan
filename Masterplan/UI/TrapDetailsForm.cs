...
{
	internal class TrapDetailsForm : Form
	{
		private Trap fTrap;
		...
		{
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(TrapDetailsForm));
			...
			base.Name = "TrapDetailsForm";
			base.ShowIcon = false;
			base.ShowInTaskbar = false;
			base.SizeGripStyle = System.Windows.Forms.SizeGripStyle.Hide;
			base.StartPosition = FormStartPosition.CenterParent;
			this.Text = "Trap / Hazard Details";
		...
		private void PlayerViewBtn_Click(object sender, EventArgs e)
		{
			...
			Session.PlayerView.ShowTrap(this.fTrap);
		}
	}
}