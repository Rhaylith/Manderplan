...
namespace Masterplan.UI
{
	internal class PowerActionForm : Form
	{
		...
		private void Application_Idle(object sender, EventArgs e)
		{
			...
			this.BasicAttackBtn.Enabled = (!this.UsageGroup.Enabled ? false : this.AtWillBtn.Checked);
			this.RechargeLbl.Enabled = (!this.UsageGroup.Enabled ? false : this.EncounterBtn.Checked);
			this.RechargeBox.Enabled = (!this.UsageGroup.Enabled ? false : this.EncounterBtn.Checked);
		...
		private void InitializeComponent()
		{
			...
			base.ClientSize = new System.Drawing.Size(305, 323);
