...
namespace Masterplan.UI
{
	internal class SeasonForm : Form
	{
		...
		{
			this.fSeason.Name = this.NameBox.Text;
			this.fSeason.DayIndex = (int)this.DayBox.Value - 1;
			MonthInfo selectedItem = this.MonthBox.SelectedItem as MonthInfo;
			this.fSeason.MonthID = selectedItem.ID;
		}
	}
}