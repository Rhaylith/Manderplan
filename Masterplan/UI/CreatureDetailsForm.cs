...
namespace Masterplan.UI
{
	internal class CreatureDetailsForm : Form
	{
		...
		{
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(CreatureDetailsForm));
			...
			base.Name = "CreatureDetailsForm";
			base.ShowIcon = false;
			base.ShowInTaskbar = false;
			base.SizeGripStyle = System.Windows.Forms.SizeGripStyle.Hide;
			base.StartPosition = FormStartPosition.CenterParent;
			this.Text = "Creature Details";
		...
		private void PlayerViewBtn_Click(object sender, EventArgs e)
		{
			if (this.fCard != null)
			{
				...
				Session.PlayerView.ShowEncounterCard(this.fCard);
			}
		}
	}
}