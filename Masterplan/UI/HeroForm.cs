...
namespace Masterplan.UI
{
	internal class HeroForm : Form
	{
		...
		public HeroForm(Masterplan.Data.Hero h)
		{
		...
		{
			EffectForm effectForm = new EffectForm(new OngoingCondition(), this.fHero);
		...
		private void EffectEditBtn_Click(object sender, EventArgs e)
		{
			...
			{
				int effect = this.fHero.Effects.IndexOf(this.SelectedEffect);
				EffectForm effectForm = new EffectForm(this.SelectedEffect, this.fHero);
				if (effectForm.ShowDialog() == System.Windows.Forms.DialogResult.OK)
				{
					this.fHero.Effects[effect] = effectForm.Effect;
					this.update_effects();
				}
			}
			if (this.SelectedToken != null)
			{
				int token = this.fHero.Tokens.IndexOf(this.SelectedToken);
				switch (this.SelectedToken.Type)
				{
					case CustomTokenType.Token:
					{
						...
						this.fHero.Tokens[token] = customTokenForm.Token;
						this.update_effects();
						return;
					}
					case CustomTokenType.Overlay:
					{
						...
						this.fHero.Tokens[token] = customOverlayForm.Token;
						this.update_effects();
						break;
					}
					default:
		...
		private void InitializeComponent()
		{
			...
			ListViewGroup listViewGroup1 = new ListViewGroup("Map Tokens", HorizontalAlignment.Left);
			ListViewGroup listViewGroup2 = new ListViewGroup("Map Overlays", HorizontalAlignment.Left);
			...
			this.PlayerLbl.Size = new System.Drawing.Size(39, 13);
			...
			this.SizeBox.Size = new System.Drawing.Size(180, 21);
			...
			this.RaceLbl.Size = new System.Drawing.Size(36, 13);
			...
			this.ClassLbl.Size = new System.Drawing.Size(35, 13);
			...
			this.RoleLbl.Size = new System.Drawing.Size(60, 13);
			...
			this.RoleBox.Size = new System.Drawing.Size(180, 21);
			...
			this.SourceBox.Size = new System.Drawing.Size(180, 21);
			...
			this.PPLbl.Size = new System.Drawing.Size(75, 13);
			...
			this.EDLbl.Size = new System.Drawing.Size(69, 13);
			...
			this.NameGroup.Size = new System.Drawing.Size(275, 105);
			...
			this.LevelBox.Size = new System.Drawing.Size(180, 20);
			...
			this.Pages.Size = new System.Drawing.Size(295, 394);
			...
			this.GeneralPage.Size = new System.Drawing.Size(287, 368);
			...
			this.LanguageGroup.Size = new System.Drawing.Size(275, 58);
			...
			this.LanguageBox.Size = new System.Drawing.Size(263, 33);
			...
			this.PortraitGroup.Size = new System.Drawing.Size(275, 292);
			...
			this.PortraitPanel.Size = new System.Drawing.Size(263, 267);
			...
			this.PortraitBox.Size = new System.Drawing.Size(263, 242);
			this.PortraitBox.SizeMode = PictureBoxSizeMode.Zoom;
			this.PortraitBox.TabIndex = 1;
			this.PortraitBox.TabStop = false;
			ToolStripItemCollection items = this.PortraitToolbar.Items;
			ToolStripItem[] portraitBrowse = new ToolStripItem[] { this.PortraitBrowse, this.PortraitPasteBtn, this.PortraitClear };
			items.AddRange(portraitBrowse);
			...
			this.StatsPage.Size = new System.Drawing.Size(287, 368);
			...
			this.InitGroup.Size = new System.Drawing.Size(275, 53);
			...
			initBox.Minimum = new decimal(numArray3);
			this.InitBox.Name = "InitBox";
			this.InitBox.Size = new System.Drawing.Size(180, 20);
			...
			this.HPGroup.Size = new System.Drawing.Size(275, 53);
			...
			int[] numArray4 = new int[] { 500, 0, 0, 0 };
			hPBox.Maximum = new decimal(numArray4);
			this.HPBox.Name = "HPBox";
			this.HPBox.Size = new System.Drawing.Size(180, 20);
			...
			this.SkillsGroup.Size = new System.Drawing.Size(275, 79);
			...
			this.InsightLbl.Size = new System.Drawing.Size(41, 13);
			...
			this.PerceptionLbl.Size = new System.Drawing.Size(58, 13);
			...
			this.DefencesGroup.Size = new System.Drawing.Size(275, 131);
			...
			this.EffectsPage.Size = new System.Drawing.Size(287, 368);
			...
			listViewGroup1.Header = "Map Tokens";
			listViewGroup1.Name = "listViewGroup2";
			listViewGroup2.Header = "Map Overlays";
			listViewGroup2.Name = "listViewGroup3";
			this.EffectList.Groups.AddRange(new ListViewGroup[] { listViewGroup, listViewGroup1, listViewGroup2 });
			...
			this.EffectList.Size = new System.Drawing.Size(281, 266);
			...
			ToolStripItemCollection toolStripItemCollections = this.EffectToolbar.Items;
			ToolStripItem[] effectAddBtn = new ToolStripItem[] { this.EffectAddBtn, this.EffectRemoveBtn, this.EffectEditBtn };
			toolStripItemCollections.AddRange(effectAddBtn);
			...
			ToolStripItemCollection dropDownItems = this.EffectAddBtn.DropDownItems;
			ToolStripItem[] effectAddToken = new ToolStripItem[] { this.effectToolStripMenuItem, this.toolStripSeparator1, this.EffectAddToken, this.EffectAddOverlay };
			dropDownItems.AddRange(effectAddToken);
			...
			this.EffectLbl.Size = new System.Drawing.Size(281, 71);
			...
			base.ClientSize = new System.Drawing.Size(319, 447);
		...
		{
			if ((new HeroIPlay4eForm(this.fHero.Key, true)).ShowDialog() == System.Windows.Forms.DialogResult.OK)
			{
				Masterplan.Data.Hero hero = new Masterplan.Data.Hero()
				{
					Key = this.fHero.Key
				};
		...
		private void update_effects()
		{
			...
			foreach (OngoingCondition effect in this.fHero.Effects)
			{
				ListViewItem item = this.EffectList.Items.Add(effect.ToString(null, false));
				item.Tag = effect;
				item.Group = this.EffectList.Groups[0];
			}
			foreach (CustomToken token in this.fHero.Tokens)
			{
				ListViewItem listViewItem = this.EffectList.Items.Add(token.Name);
				...
				switch (token.Type)
				{
					...
					case CustomTokenType.Overlay:
					{
						listViewItem.Group = this.EffectList.Groups[2];
						continue;
					}
					default:
					{
