...
namespace Masterplan.UI
{
	internal class SkillChallengeSkillForm : Form
	{
		...
		private void InitializeComponent()
		{
			...
			base.ClientSize = new System.Drawing.Size(314, 352);
		...
		{
			bool text = this.TypeBox.Text == "This skill incurs an automatic failure";
			this.DiffLbl.Enabled = !text;
			this.DiffBox.Enabled = !text;
			this.ModLbl.Enabled = !text;
			this.ModBox.Enabled = !text;
			if (text)
			{
