...
namespace Masterplan.UI
{
	internal class OptionCreatureLoreForm : Form
	{
		...
		private Masterplan.Data.CreatureLore fCreatureLore;

		public Masterplan.Data.CreatureLore CreatureLore
		{
			get
			{
		...
		private void update_information()
		{
			...
			foreach (Pair<int, string> information in this.fCreatureLore.Information)
			{
				object[] first = new object[] { "DC ", information.First, ": ", information.Second };
				string str = string.Concat(first);
				this.InfoList.Items.Add(str).Tag = information;
			}
		}
	}
}