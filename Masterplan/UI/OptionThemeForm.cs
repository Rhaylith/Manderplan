...
namespace Masterplan.UI
{
	internal class OptionThemeForm : Form
	{
		...
		private Masterplan.Data.Theme fTheme;
		...
		public Masterplan.Data.Theme Theme
		{
			get
			{
				return this.fTheme;
		...
		public OptionThemeForm(Masterplan.Data.Theme theme)
		{
		...
		private void FeatureEditBtn_Click(object sender, EventArgs e)
		{
			...
			{
				int level = this.fTheme.Levels.IndexOf(this.SelectedLevel);
				...
				{
					this.fTheme.Levels[level] = optionLevelForm.Level;
					this.update_levels();
				}
			}
		}
		...
		{
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(OptionThemeForm));
			...
			this.LevelList.Columns.AddRange(new ColumnHeader[] { this.FeatureHdr });
			...
			base.ClientSize = new System.Drawing.Size(373, 405);
		...
		private void update_levels()
		{
			...
			foreach (LevelData level in this.fTheme.Levels)
			{
