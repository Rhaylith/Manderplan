...
{
	internal class TerrainPowerDetailsForm : Form
	{
		...
		private void ExportHTML_Click(object sender, EventArgs e)
		{
			...
			{
				FileName = this.fTerrainPower.Name,
		...
		{
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(TerrainPowerDetailsForm));
			...
			base.Name = "TerrainPowerDetailsForm";
			base.ShowIcon = false;
			base.ShowInTaskbar = false;
			base.SizeGripStyle = System.Windows.Forms.SizeGripStyle.Hide;
			base.StartPosition = FormStartPosition.CenterParent;
			this.Text = "Terrain Power Details";
		...
		private void PlayerViewBtn_Click(object sender, EventArgs e)
		{
			...
			Session.PlayerView.ShowTerrainPower(this.fTerrainPower);
		}
	}
}