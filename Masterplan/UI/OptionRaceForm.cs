...
namespace Masterplan.UI
{
	internal class OptionRaceForm : Form
	{
		...
		private Masterplan.Data.Race fRace;

		public Masterplan.Data.Race Race
		{
			get
			{
				return this.fRace;
		...
		public OptionRaceForm(Masterplan.Data.Race race)
		{
		...
		private void PowerEditBtn_Click(object sender, EventArgs e)
		{
			...
			{
				int power = this.fRace.Powers.IndexOf(this.SelectedPower);
				OptionPowerForm optionPowerForm = new OptionPowerForm(this.SelectedPower);
				if (optionPowerForm.ShowDialog() == System.Windows.Forms.DialogResult.OK)
				{
					this.fRace.Powers[power] = optionPowerForm.Power;
					this.update_powers();
				}
			}
		}
		...
		private void update_features()
		{
			...
			foreach (Feature feature in this.fRace.Features)
			{
		...
		private void update_powers()
		{
			...
			foreach (PlayerPower power in this.fRace.Powers)
			{
