...
namespace Masterplan.UI
{
	internal class CreatureSkillForm : Form
	{
		...
		public CreatureSkillForm(string skill_name, string ability_name, int ability_bonus, int level_bonus, bool trained, int misc_bonus)
		{
			...
			this.AbilityNameLbl.Text = string.Concat(ability_name, " bonus:");
		...
		private void InitializeComponent()
		{
			...
			NumericUpDown miscBox = this.MiscBox;
			int[] numArray = new int[] { 100, 0, 0, -2147483648 };
			miscBox.Minimum = new decimal(numArray);
			...
			this.TotalLbl.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25f, FontStyle.Bold, GraphicsUnit.Point, 0);
			...
			this.TotalBonusLbl.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25f, FontStyle.Bold, GraphicsUnit.Point, 0);
			...
			base.ClientSize = new System.Drawing.Size(199, 173);
		...
		private void update_total()
		{
			...
			int misc = this.fAbility + this.fLevel + num + this.Misc;
			this.TrainingBonusLbl.Text = (this.TrainedBox.Checked ? "5" : "");
			this.TotalBonusLbl.Text = misc.ToString();
		}
	}
}