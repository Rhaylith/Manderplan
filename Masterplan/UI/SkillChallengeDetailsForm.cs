...
namespace Masterplan.UI
{
	internal class SkillChallengeDetailsForm : Form
	{
		...
		{
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(SkillChallengeDetailsForm));
			...
			base.Name = "SkillChallengeDetailsForm";
			base.ShowIcon = false;
			base.ShowInTaskbar = false;
			base.SizeGripStyle = System.Windows.Forms.SizeGripStyle.Hide;
			base.StartPosition = FormStartPosition.CenterParent;
			this.Text = "Skill Challenge Details";
		...
		private void PlayerViewBtn_Click(object sender, EventArgs e)
		{
			...
			Session.PlayerView.ShowSkillChallenge(this.fChallenge);
		}
	}
}