	...
	internal class SkillChallengeSelectForm : Form
	{
		...
		public Masterplan.Data.SkillChallenge SkillChallenge
		{
			get
			{
				...
				return this.ChallengeList.SelectedItems[0].Tag as Masterplan.Data.SkillChallenge;
			}
		}
		...
		public SkillChallengeSelectForm()
		{
			...
			foreach (Masterplan.Data.SkillChallenge skillChallenge in Session.SkillChallenges)
			{
		...
		{
			string str = HTML.SkillChallenge(this.SkillChallenge, false, true, DisplaySize.Small);
