...
namespace Masterplan.UI
{
	internal class LibraryListForm : Form
	{
		...
		private void InitializeComponent()
		{
			...
			ToolStripItemCollection items = this.LibraryToolbar.Items;
			...
			dropDownItems.AddRange(fileNew);
			...
			columns.AddRange(creatureNameHdr);
			...
			ToolStripItemCollection toolStripItemCollections = this.CreatureContext.Items;
			ToolStripItem[] creatureContextRemove = new ToolStripItem[] { this.CreatureContextRemove, this.CreatureContextCategory };
			toolStripItemCollections.AddRange(creatureContextRemove);
			...
			ToolStripItemCollection items1 = this.CreatureSearchToolbar.Items;
			...
			ToolStripItemCollection toolStripItemCollections1 = this.CreatureToolbar.Items;
			...
			toolStripItemCollections1.AddRange(creatureAddBtn);
			...
			ToolStripItemCollection dropDownItems2 = this.CreatureTools.DropDownItems;
			...
			dropDownItems2.AddRange(creatureToolsDemographics);
			...
			ListView.ColumnHeaderCollection columnHeaderCollections = this.TemplateList.Columns;
			ColumnHeader[] templateNameHdr = new ColumnHeader[] { this.TemplateNameHdr, this.TemplateInfoHdr };
			columnHeaderCollections.AddRange(templateNameHdr);
			...
			ListViewGroupCollection groups = this.TemplateList.Groups;
			...
			ToolStripItemCollection toolStripItemCollections2 = this.TemplateContextType.DropDownItems;
			ToolStripItem[] templateFunctional = new ToolStripItem[] { this.TemplateFunctional, this.TemplateClass };
			toolStripItemCollections2.AddRange(templateFunctional);
			...
			ToolStripItemCollection items3 = this.TemplateToolbar.Items;
			...
			items3.AddRange(templateAddBtn);
			...
			ToolStripItemCollection dropDownItems3 = this.TemplateAddBtn.DropDownItems;
			...
			dropDownItems3.AddRange(templateAddTheme);
			...
			ListView.ColumnHeaderCollection columns1 = this.TrapList.Columns;
			ColumnHeader[] trapNameHdr = new ColumnHeader[] { this.TrapNameHdr, this.TrapInfoHdr };
			columns1.AddRange(trapNameHdr);
			...
			ToolStripItemCollection toolStripItemCollections3 = this.TrapContext.Items;
			ToolStripItem[] trapContextRemove = new ToolStripItem[] { this.TrapContextRemove, this.TrapContextType };
			toolStripItemCollections3.AddRange(trapContextRemove);
			...
			ToolStripItemCollection dropDownItems4 = this.TrapContextType.DropDownItems;
			ToolStripItem[] trapTrap = new ToolStripItem[] { this.TrapTrap, this.TrapHazard };
			dropDownItems4.AddRange(trapTrap);
			...
			ToolStripItemCollection items4 = this.TrapToolbar.Items;
			...
			ToolStripItemCollection toolStripItemCollections4 = this.TrapAdd.DropDownItems;
			ToolStripItem[] trapAddAdd = new ToolStripItem[] { this.TrapAddAdd, this.toolStripSeparator25, this.TrapAddImport };
			toolStripItemCollections4.AddRange(trapAddAdd);
			...
			ToolStripItemCollection dropDownItems5 = this.TrapTools.DropDownItems;
			ToolStripItem[] trapToolsDemographics = new ToolStripItem[] { this.TrapToolsDemographics, this.TrapToolsExport };
			dropDownItems5.AddRange(trapToolsDemographics);
			...
			ListView.ColumnHeaderCollection columnHeaderCollections1 = this.ChallengeList.Columns;
			ColumnHeader[] challengeNameHdr = new ColumnHeader[] { this.ChallengeNameHdr, this.ChallengeInfoHdr };
			columnHeaderCollections1.AddRange(challengeNameHdr);
			...
			ToolStripItemCollection items5 = this.ChallengeToolbar.Items;
			...
			ToolStripItemCollection toolStripItemCollections5 = this.ChallengeAdd.DropDownItems;
			ToolStripItem[] challengeAddAdd = new ToolStripItem[] { this.ChallengeAddAdd, this.toolStripSeparator26, this.ChallengeAddImport };
			toolStripItemCollections5.AddRange(challengeAddAdd);
			...
			ToolStripItemCollection toolStripItemCollections6 = this.MagicItemTools.DropDownItems;
			ToolStripItem[] magicItemToolsDemographics = new ToolStripItem[] { this.MagicItemToolsDemographics, this.MagicItemToolsExport };
			toolStripItemCollections6.AddRange(magicItemToolsDemographics);
			...
			ToolStripItemCollection items7 = this.MagicItemVersionToolbar.Items;
			...
			items7.AddRange(magicItemRemoveBtn);
			...
			ToolStripItemCollection toolStripItemCollections7 = this.TileContext.Items;
			ToolStripItem[] tileContextRemove = new ToolStripItem[] { this.TileContextRemove, this.TileContextCategory, this.TileContextSize };
			toolStripItemCollections7.AddRange(tileContextRemove);
			...
			ToolStripItemCollection dropDownItems7 = this.TileContextCategory.DropDownItems;
			...
			dropDownItems7.AddRange(tilePlain);
			...
			ToolStripItemCollection items8 = this.TileToolbar.Items;
			...
			ToolStripItemCollection dropDownItems8 = this.TileAddBtn.DropDownItems;
			...
			dropDownItems8.AddRange(tileAddImport);
			...
			ListView.ColumnHeaderCollection columns2 = this.TerrainPowerList.Columns;
			ColumnHeader[] tPNameHdr = new ColumnHeader[] { this.TPNameHdr, this.TPInfoHdr };
			columns2.AddRange(tPNameHdr);
			...
			ToolStripItemCollection toolStripItemCollections8 = this.TerrainPowerToolbar.Items;
			...
			toolStripItemCollections8.AddRange(tPAdd);
			...
			ToolStripItemCollection toolStripItemCollections9 = this.TPTools.DropDownItems;
			fileMenu = new ToolStripItem[] { this.TPToolsExport };
			toolStripItemCollections9.AddRange(fileMenu);
			...
			ListView.ColumnHeaderCollection columnHeaderCollections2 = this.ArtifactList.Columns;
			creatureNameHdr = new ColumnHeader[] { this.ArtifactHdr, this.ArtifactInfoHdr };
			columnHeaderCollections2.AddRange(creatureNameHdr);
			...
			ListViewGroupCollection listViewGroupCollections = this.ArtifactList.Groups;
			listViewGroupArray = new ListViewGroup[] { listViewGroup12, listViewGroup13 };
			listViewGroupCollections.AddRange(listViewGroupArray);
			...
			ToolStripItemCollection items9 = this.ArtifactContext.Items;
			fileMenu = new ToolStripItem[] { this.ArtifactContextRemove };
			items9.AddRange(fileMenu);
			...
			ToolStripItemCollection items10 = this.ArtifactToolbar.Items;
			fileMenu = new ToolStripItem[] { this.ArtifactAdd, this.ArtifactRemove, this.ArtifactEdit, this.toolStripSeparator32, this.ArtifactCut, this.ArtifactCopy, this.ArtifactPaste, this.toolStripSeparator33, this.ArtifactStatBlockBtn, this.toolStripSeparator34, this.ArtifactTools };
			items10.AddRange(fileMenu);
			...
			ToolStripItemCollection dropDownItems10 = this.ArtifactAdd.DropDownItems;
			fileMenu = new ToolStripItem[] { this.ArtifactAddAdd, this.toolStripSeparator31, this.ArtifactAddImport };
			dropDownItems10.AddRange(fileMenu);
			...
			ToolStripItemCollection toolStripItemCollections10 = this.ArtifactTools.DropDownItems;
			fileMenu = new ToolStripItem[] { this.ArtifactToolsExport };
			toolStripItemCollections10.AddRange(fileMenu);
			...
			ToolStripItemCollection items11 = this.ChallengeContext.Items;
			fileMenu = new ToolStripItem[] { this.ChallengeContextRemove };
			items11.AddRange(fileMenu);
