...
namespace Masterplan.UI
{
	internal class EncounterBuilderForm : Form
	{
		...
		private void InitializeComponent()
		{
			...
			base.SuspendLayout();
			ListView.ColumnHeaderCollection columns = this.DifficultyList.Columns;
			...
			ListView.ColumnHeaderCollection columnHeaderCollections = this.SlotList.Columns;
			ColumnHeader[] threatHdr = new ColumnHeader[] { this.ThreatHdr, this.ThreatInfoHdr, this.CountHdr, this.XPHdr };
			columnHeaderCollections.AddRange(threatHdr);
			...
			ToolStripItemCollection items = this.ThreatContextMenu.Items;
			...
			ToolStripItemCollection dropDownItems = this.EditSwap.DropDownItems;
			...
			dropDownItems.AddRange(swapStandard);
			...
			ToolStripItemCollection toolStripItemCollections = this.EncToolbar.Items;
			...
			toolStripItemCollections1.AddRange(toolsClearAll);
			...
			ListView.ColumnHeaderCollection columns1 = this.SourceItemList.Columns;
			ColumnHeader[] nameHdr = new ColumnHeader[] { this.NameHdr, this.InfoHdr };
			columns1.AddRange(nameHdr);
			...
			toolStripItemCollections2.AddRange(mapContextView);
			...
			ToolStripItemCollection dropDownItems3 = this.MapToolsMenu.DropDownItems;
			...
			dropDownItems3.AddRange(mapToolsLOS);
			...
			ToolStripItemCollection toolStripItemCollections3 = this.MapCreaturesMenu.DropDownItems;
			...
			toolStripItemCollections3.AddRange(mapCreaturesRemove);
			...
			ToolStripItemCollection items4 = this.NoteToolbar.Items;
