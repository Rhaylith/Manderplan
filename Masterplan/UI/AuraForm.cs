...
namespace Masterplan.UI
{
	internal class AuraForm : Form
	{
		...
		public AuraForm(Masterplan.Data.Aura aura)
		{
		...
		private void InitializeComponent()
		{
			...
			base.ClientSize = new System.Drawing.Size(273, 266);
		...
		private void OKBtn_Click(object sender, EventArgs e)
		{
			...
			this.fAura.Details = string.Concat(this.SizeBox.Value, ": ", this.DetailsBox.Text);
		}
	}
}