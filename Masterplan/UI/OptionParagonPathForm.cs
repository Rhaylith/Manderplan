...
namespace Masterplan.UI
{
	internal class OptionParagonPathForm : Form
	{
		...
		private Masterplan.Data.ParagonPath fParagonPath;

		public Masterplan.Data.ParagonPath ParagonPath
		{
			get
			{
		...
		private void FeatureEditBtn_Click(object sender, EventArgs e)
		{
			...
			{
				int level = this.fParagonPath.Levels.IndexOf(this.SelectedLevel);
				...
				{
					this.fParagonPath.Levels[level] = optionLevelForm.Level;
					this.update_levels();
				}
			}
		}
		...
		private void update_levels()
		{
			...
			foreach (LevelData level in this.fParagonPath.Levels)
			{
