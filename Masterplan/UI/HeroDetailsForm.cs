...
{
	internal class HeroDetailsForm : Form
	{
		private Hero fHero;
		...
		public HeroDetailsForm(Hero hero)
		{
			...
			this.fHero = hero.Copy();
			this.Browser.DocumentText = HTML.StatBlock(this.fHero, null, true, false, false, DisplaySize.Small);
		}
		...
		private void PlayerViewBtn_Click(object sender, EventArgs e)
		{
			...
			Session.PlayerView.ShowHero(this.fHero);
		}
	}
}